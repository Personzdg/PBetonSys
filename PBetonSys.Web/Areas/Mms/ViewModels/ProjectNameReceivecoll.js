...
var viewModel = function () {
    ...
    this.grid = {
        size: { w: 4, h: 60 },
        url: '/api/Mms/Receive/GetProjectNameReceivecoll',
    ...
    this.IniTotal = function () {
        com.ajax({
            ...
            url: '/api/mms/Receive/GetTotalProjectNameReceivecoll',
            success: function (d) {
                if (d.方量 < 1) {
                    return false;
                }
                ...
                self.grid.datagrid("appendRow", { 工程名称: '<b>合计：</b>', 方量: d.方量,  summoney: d.summoney, 泵费: d.泵费, 运费: d.运费, mtvalue1_1: d.mtvalue1_1, mtvalue1_2: d.mtvalue1_2, mtvalue2_1: d.mtvalue2_1, mtvalue2_2: d.mtvalue2_2, mtvalue2: d.mtvalue2, mtvalue3: d.mtvalue3, mtvalue4: d.mtvalue4, mtvalue5: d.mtvalue5, mtvalue6: d.mtvalue6, mtvalue7: d.mtvalue7, mtvalue8: d.mtvalue8, mtvalue9: d.mtvalue9 });
