...
var viewModel = function () {
    ...
    this.grid = {
        size: { w: 4, h: 40 },
        url: '/api/Mms/Clinet/GetClientList',
        queryParams: ko.observable(),
        pagination: true,
        loadFilter: function (d) {
            d.rows = utils.copyProperty(d.rows, 'Clinet_id', '_id');
            return d;
        }
    };
    ...
    this.saveClick = function () {
        self.gridEdit.ended();
        var post = {};
        post.list = self.gridEdit.getChanges(['_id', 'Clinet_id', 'Name', 'CheckDateTime', 'State', 'Remark', 'ClerkID', 'LinkName', 'LinkPhon', 'WXCode', 'Password']);
