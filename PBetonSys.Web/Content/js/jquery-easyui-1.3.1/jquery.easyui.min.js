...
function _18d(node){
node.each(function(){
try{ //mod by zhdg add try catch to prevent the error __flash__removeCallback 未定义 when close the tab which contains flash 
$(this).remove();
if($.browser.msie){
this.outerHTML="";
}}
...
//add by zhdg start for clear memory 
...
_705.find("input.combo-text").width(_705.width()-_707 - 3); //modify by zhdg
