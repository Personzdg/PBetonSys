...
namespace PBetonSys.Utils.NPOI.Util
{
    using System;
    ...
    /// the header has been written.  The client code can call <see cref="M:PBetonSys.Utils.NPOI.Util.IDelayableLittleEndianOutput.CreateDelayedOutput"/>
