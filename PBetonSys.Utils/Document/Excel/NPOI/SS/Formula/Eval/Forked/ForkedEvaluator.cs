...
namespace PBetonSys.Utils.NPOI.SS.Formula.Eval.Forked
{
     ...
     * 90% of memory consumption is due to loading of the {@link HSSFWorkbook} or {@link PBetonSys.Utils.NPOI.xssf.usermodel.XSSFWorkbook}.
