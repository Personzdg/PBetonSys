...
namespace PBetonSys.Utils.NPOI.SS.Formula
{
    ...
    using PBetonSys.Utils.NPOI.SS.Formula.Functions;
    ...
    class OperationEvaluatorFactory
    {
        ...
        private static void Add(Hashtable m, OperationPtg ptgKey,
            PBetonSys.Utils.NPOI.SS.Formula.Functions.Function instance)
        {
                ...
                OperationEvaluationContext ec)
        {
            ...
            PBetonSys.Utils.NPOI.SS.Formula.Functions.Function result = _instancesByPtgClass[ptg] as PBetonSys.Utils.NPOI.SS.Formula.Functions.Function;
            ...
            if (ptg is AbstractFunctionPtg)
            {
                ...
                {
                    case PBetonSys.Utils.NPOI.SS.Formula.Function.FunctionMetadataRegistry.FUNCTION_INDEX_INDIRECT:
                        return Indirect.instance.Evaluate(args, ec);
                    case PBetonSys.Utils.NPOI.SS.Formula.Function.FunctionMetadataRegistry.FUNCTION_INDEX_EXTERNAL:
