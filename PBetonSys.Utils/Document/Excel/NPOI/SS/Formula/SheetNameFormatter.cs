...
namespace PBetonSys.Utils.NPOI.SS.Formula
{
    ...
    public class SheetNameFormatter
    {
        ...
        {
            return PBetonSys.Utils.NPOI.SS.Util.CellReference.CellReferenceIsWithinRange(lettersPrefix, numbersSuffix, PBetonSys.Utils.NPOI.SS.SpreadsheetVersion.EXCEL97);
        }
