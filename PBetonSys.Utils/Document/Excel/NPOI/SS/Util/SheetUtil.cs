...
namespace PBetonSys.Utils.NPOI.SS.Util
{
    ...
    public class SheetUtil
    {
         ...
         *  {@link PBetonSys.Utils.NPOI.SS.UserModel.DataFormatter#formatCellValue(PBetonSys.Utils.NPOI.SS.UserModel.Cell)}
        ...
        public static double GetColumnWidth(ISheet sheet, int column, bool useMergedCells)
        {
            ...
            using (Bitmap bmp = new Bitmap(2048, 100))
            {
                ...
                for (IEnumerator it = sheet.GetRowEnumerator(); it.MoveNext(); )
                {
                    ...
                    PBetonSys.Utils.NPOI.SS.UserModel.IFont font1 = wb.GetFontAt(style.FontIndex);
