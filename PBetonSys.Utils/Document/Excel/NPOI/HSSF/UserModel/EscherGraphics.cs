...
namespace PBetonSys.Utils.NPOI.HSSF.UserModel
{
    ...
    public class EscherGraphics : IDisposable
    {
        ...
        private HSSFFont MatchFont(Font font)
        {
            ...
            HSSFFont hssfFont = (HSSFFont)workbook.FindFont(bold ? (short)PBetonSys.Utils.NPOI.SS.UserModel.FontBoldWeight.BOLD : (short)PBetonSys.Utils.NPOI.SS.UserModel.FontBoldWeight.NORMAL,
                        hssfColor.GetIndex(),
                        (short)(font.Size * 20),
                        font.Name,
                        italic,
                        false,
                        (short)PBetonSys.Utils.NPOI.SS.UserModel.FontSuperScript.NONE,
                        (byte)PBetonSys.Utils.NPOI.SS.UserModel.FontUnderlineType.NONE
                        );
            if (hssfFont == null)
            {
                hssfFont = (HSSFFont)workbook.CreateFont();
                hssfFont.Boldweight = (short)(bold ? PBetonSys.Utils.NPOI.SS.UserModel.FontBoldWeight.BOLD : 0);
