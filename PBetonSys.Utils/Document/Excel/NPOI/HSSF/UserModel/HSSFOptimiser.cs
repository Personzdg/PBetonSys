...
namespace PBetonSys.Utils.NPOI.HSSF.UserModel
{
    ...
    public class HSSFOptimiser
    {
        ...
        public static void OptimiseFonts(HSSFWorkbook workbook)
        {
            ...
            {
                PBetonSys.Utils.NPOI.SS.UserModel.ISheet s = workbook.GetSheetAt(sheetNum);
                ...
                while (rIt.MoveNext())
                {
                    ...
                    while (cIt.MoveNext())
                    {
                        ...
                        if (cell.CellType == PBetonSys.Utils.NPOI.SS.UserModel.CellType.STRING)
                        {
            ...
            for (int sheetNum = 0; sheetNum < workbook.NumberOfSheets; sheetNum++)
            {
                ...
                while (rIt.MoveNext())
                {
                    ...
                    while (cIt.MoveNext())
                    {
                        ...
                        PBetonSys.Utils.NPOI.SS.UserModel.ICellStyle newStyle = workbook.GetCellStyleAt(
                                newPos[oldXf]
                        );
