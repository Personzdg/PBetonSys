...
namespace PBetonSys.Utils.NPOI.HSSF.UserModel
{
    ...
    /// </summary> 
    [Serializable]
    public class HSSFRichTextString : IComparable<HSSFRichTextString>,PBetonSys.Utils.NPOI.SS.UserModel.IRichTextString
    {
        ...
        public void ApplyFont(int startIndex, int endIndex, PBetonSys.Utils.NPOI.SS.UserModel.IFont font)
        {
        ...
        public void ApplyFont(PBetonSys.Utils.NPOI.SS.UserModel.IFont font)
        {
