...
namespace PBetonSys.Utils.NPOI.HSSF.UserModel
{
    ...
    using PBetonSys.Utils.NPOI.POIFS.FileSystem;
    using PBetonSys.Utils.NPOI.SS.Formula;
    using PBetonSys.Utils.NPOI.SS.Formula.PTG;
    using PBetonSys.Utils.NPOI.SS.Formula.Udf;
    ...
    public class HSSFWorkbook : POIDocument, IWorkbook
    {
        ...
        public PBetonSys.Utils.NPOI.SS.UserModel.ICreationHelper GetCreationHelper()
        {
        ...
        /// </summary>
        private class SheetRecordCollector : PBetonSys.Utils.NPOI.HSSF.Record.Aggregates.RecordVisitor,IDisposable
        {
     ...
     */
        ...
        [NonSerialized]
        private PBetonSys.Utils.NPOI.SS.UserModel.MissingCellPolicy missingCellPolicy = PBetonSys.Utils.NPOI.SS.UserModel.MissingCellPolicy.RETURN_NULL_AND_BLANK;
        /// <summary>
        ...
        public PBetonSys.Utils.NPOI.SS.UserModel.MissingCellPolicy MissingCellPolicy
        {
        ...
        public PBetonSys.Utils.NPOI.SS.UserModel.ISheet GetSheetAt(int index)
        {
        ...
        public PBetonSys.Utils.NPOI.SS.UserModel.ISheet GetSheet(String name)
        {
                                               ...
                                               int startRow, int endRow)
        {
            ...
            PBetonSys.Utils.NPOI.SS.UserModel.IPrintSetup printSetup = sheet.PrintSetup;
        ...
        public PBetonSys.Utils.NPOI.SS.UserModel.IFont CreateFont()
        {
        ...
        //public PBetonSys.Utils.NPOI.SS.UserModel.Font FindFont(PBetonSys.Utils.NPOI.SS.UserModel.FontBoldWeight boldWeight, short color, short fontHeight,
        //                 String name, bool italic, bool strikeout,
        //                 PBetonSys.Utils.NPOI.SS.UserModel.FontSuperScript typeOffset, PBetonSys.Utils.NPOI.SS.UserModel.FontUnderlineType Underline)
        //{
        ...
        /// <returns></returns>
        public PBetonSys.Utils.NPOI.SS.UserModel.IFont FindFont(short boldWeight, short color, short fontHeight,
                         String name, bool italic, bool strikeout,
                         short typeOffset, byte Underline)
        {
            ...
            for (short i = 0; i <= this.NumberOfFonts; i++)
            {
                ...
                PBetonSys.Utils.NPOI.SS.UserModel.IFont hssfFont = GetFontAt(i);
        ...
        public PBetonSys.Utils.NPOI.SS.UserModel.IFont GetFontAt(short idx)
        {
        ...
        public PBetonSys.Utils.NPOI.SS.UserModel.ICellStyle CreateCellStyle()
        {
        ...
        public PBetonSys.Utils.NPOI.SS.UserModel.ICellStyle GetCellStyleAt(short idx)
        {
 ...
 */
        ...
        public PBetonSys.Utils.NPOI.SS.UserModel.IName GetName(String name)
        {
        ...
        public PBetonSys.Utils.NPOI.SS.UserModel.IName GetNameAt(int index)
        {
        ...
        /// </summary>
        /// <returns>named range high level</returns>
        public PBetonSys.Utils.NPOI.SS.UserModel.IName CreateName()
        {
        ...
        public PBetonSys.Utils.NPOI.SS.UserModel.IDataFormat CreateDataFormat()
        {
            if (formatter == null)
        ...
        public int AddPicture(byte[] pictureData, PBetonSys.Utils.NPOI.SS.UserModel.PictureType format)
        {
            InitDrawings();
            ...
            switch (format)
            {
                case PBetonSys.Utils.NPOI.SS.UserModel.PictureType.EMF:
                    blipRecord.Options = HSSFPictureData.MSOBI_EMF;
                    break;
                case PBetonSys.Utils.NPOI.SS.UserModel.PictureType.WMF:
                    blipRecord.Options = HSSFPictureData.MSOBI_WMF;
                    break;
                case PBetonSys.Utils.NPOI.SS.UserModel.PictureType.PICT:
                    blipRecord.Options = HSSFPictureData.MSOBI_PICT;
                    break;
                case PBetonSys.Utils.NPOI.SS.UserModel.PictureType.PNG:
                    blipRecord.Options = HSSFPictureData.MSOBI_PNG;
                    break;
                case PBetonSys.Utils.NPOI.SS.UserModel.PictureType.JPEG:
                    blipRecord.Options = HSSFPictureData.MSOBI_JPEG;
                    break;
                case PBetonSys.Utils.NPOI.SS.UserModel.PictureType.DIB:
