...
namespace PBetonSys.Utils.NPOI.HSSF.UserModel
{
    ...
    using PBetonSys.Utils.NPOI.HSSF.Record.CF;
        ...
        public String Formula2
        {
            get
            {
                ...
                if (conditionType == CELL_COMPARISON)
                {
                    ...
                    {
                        case (byte)PBetonSys.Utils.NPOI.SS.UserModel.ComparisonOperator.BETWEEN:
                        case (byte)PBetonSys.Utils.NPOI.SS.UserModel.ComparisonOperator.NOT_BETWEEN:
