...
namespace PBetonSys.Utils.NPOI.HSSF.UserModel
{
    ...
    public class HSSFName:PBetonSys.Utils.NPOI.SS.UserModel.IName
    {
        ...
        public String RefersToFormula
        {
            ...
            set
            {
                Ptg[] ptgs = HSSFFormulaParser.Parse(value, book, PBetonSys.Utils.NPOI.SS.Formula.FormulaType.NAMEDRANGE, SheetIndex);
