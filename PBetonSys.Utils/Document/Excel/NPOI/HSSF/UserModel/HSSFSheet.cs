...
namespace PBetonSys.Utils.NPOI.HSSF.UserModel
{
    using System;
    using System.Collections;
    using System.Collections.Generic;
    using System.Windows.Forms;
    using PBetonSys.Utils.NPOI.DDF;
    using PBetonSys.Utils.NPOI.HSSF.Model;
    using PBetonSys.Utils.NPOI.HSSF.Record;
    using PBetonSys.Utils.NPOI.HSSF.Record.Aggregates;
    using PBetonSys.Utils.NPOI.HSSF.Record.AutoFilter;
    using PBetonSys.Utils.NPOI.HSSF.Util;
    using PBetonSys.Utils.NPOI.SS;
    using PBetonSys.Utils.NPOI.SS.Formula;
    using PBetonSys.Utils.NPOI.SS.Formula.PTG;
    using PBetonSys.Utils.NPOI.SS.UserModel;
    using PBetonSys.Utils.NPOI.SS.Util;
    ...
    /// </remarks>
    [Serializable]
    public class HSSFSheet : PBetonSys.Utils.NPOI.SS.UserModel.ISheet
    {
        ...
        private Dictionary<int, PBetonSys.Utils.NPOI.SS.UserModel.IRow> rows;
        ...
        /// <see cref="PBetonSys.Utils.NPOI.HSSF.UserModel.HSSFWorkbook.CreateSheet()"/>
        public HSSFSheet(HSSFWorkbook workbook)
        {
            _sheet = InternalSheet.CreateSheet();
            rows = new Dictionary<int, PBetonSys.Utils.NPOI.SS.UserModel.IRow>();
        ...
        /// <see cref="PBetonSys.Utils.NPOI.HSSF.UserModel.HSSFWorkbook(PBetonSys.Utils.NPOI.POIFS.FileSystem.DirectoryNode, bool)"/>
        ...
        public PBetonSys.Utils.NPOI.SS.UserModel.IRow CreateRow(int rownum)
        {
        ...
        private int FindLastRow(int lastrow)
        {
            ...
            PBetonSys.Utils.NPOI.SS.UserModel.IRow r = GetRow(rownum);
        ...
        /// <returns></returns>
        public PBetonSys.Utils.NPOI.SS.UserModel.ICellStyle GetColumnStyle(int column)
        {
        ...
        public PBetonSys.Utils.NPOI.SS.UserModel.IRow GetRow(int rowIndex)
        {
        ...
        [Obsolete]
        public int AddMergedRegion(PBetonSys.Utils.NPOI.SS.Util.Region region)
        {
        ...
        /// <returns>index of this region</returns>
        public int AddMergedRegion(PBetonSys.Utils.NPOI.SS.Util.CellRangeAddress region)
        {
        ...
        //public PBetonSys.Utils.NPOI.SS.Util.Region GetMergedRegionAt(int index)
        //{
        //    PBetonSys.Utils.NPOI.SS.Util.CellRangeAddress cra = GetMergedRegion(index);

        //    return new PBetonSys.Utils.NPOI.SS.Util.Region(cra.FirstRow, (short)cra.FirstColumn,
        ...
        /// Call <see cref="PBetonSys.Utils.NPOI.SS.UserModel.IRow.RowNum"/> on each row 
        ...
        public PBetonSys.Utils.NPOI.SS.UserModel.IPrintSetup PrintSetup
        {
        ...
        public PBetonSys.Utils.NPOI.SS.UserModel.IHeader Header
        {
        ...
        public PBetonSys.Utils.NPOI.SS.UserModel.IFooter Footer
        {
        ...
        public void SetEnclosedBorderOfRegion(CellRangeAddress region, PBetonSys.Utils.NPOI.SS.UserModel.BorderStyle borderType, short color)
        {
        ...
        /// <param name="borderType">Type of the border.</param>
        /// <param name="color">The color.</param>
        public void SetBorderRightOfRegion(CellRangeAddress region, PBetonSys.Utils.NPOI.SS.UserModel.BorderStyle borderType, short color)
        {
            HSSFRegionUtil.SetRightBorderColor(color, region, this, _workbook);
            HSSFRegionUtil.SetBorderRight(borderType, region, this, _workbook);
        }
        ...
        /// <param name="borderType">Type of the border.</param>
        /// <param name="color">The color.</param>
        public void SetBorderLeftOfRegion(CellRangeAddress region, PBetonSys.Utils.NPOI.SS.UserModel.BorderStyle borderType, short color)
        {
            HSSFRegionUtil.SetLeftBorderColor(color, region, this, _workbook);
            HSSFRegionUtil.SetBorderLeft(borderType, region, this, _workbook);
        }
        ...
        /// <param name="borderType">Type of the border.</param>
        /// <param name="color">The color.</param>
        public void SetBorderTopOfRegion(CellRangeAddress region, PBetonSys.Utils.NPOI.SS.UserModel.BorderStyle borderType, short color)
        {
            HSSFRegionUtil.SetTopBorderColor(color, region, this, _workbook);
            HSSFRegionUtil.SetBorderTop(borderType, region, this, _workbook);
        }
        ...
        /// <param name="borderType">Type of the border.</param>
        /// <param name="color">The color.</param>
        public void SetBorderBottomOfRegion(CellRangeAddress region, PBetonSys.Utils.NPOI.SS.UserModel.BorderStyle borderType, short color)
        {
            HSSFRegionUtil.SetBottomBorderColor(color, region, this, _workbook);
            HSSFRegionUtil.SetBorderBottom(borderType, region, this, _workbook);
        }
        ...
        protected void ShiftMerged(int startRow, int endRow, int n, bool IsRow)
        {
            ...
            {
                PBetonSys.Utils.NPOI.SS.Util.CellRangeAddress merged = this.GetMergedRegion(i);
            ...
            {
                PBetonSys.Utils.NPOI.SS.Util.CellRangeAddress region = (PBetonSys.Utils.NPOI.SS.Util.CellRangeAddress)iterator.Current;
        ...
        [Obsolete]
        private static bool ContainsCell(PBetonSys.Utils.NPOI.SS.Util.CellRangeAddress cr, int rowIx, int colIx)
        {
            ...
            bool copyRowHeight, bool resetOriginalRowHeight, bool moveComments)
        {
            ...
            for (int rowNum = s; rowNum >= startRow && rowNum <= endRow && rowNum >= 0 && rowNum < 65536; rowNum += inc)
            {
                ...
                foreach (ICell cell in cells)
                {
                    ...
                    PBetonSys.Utils.NPOI.SS.UserModel.IHyperlink link = cell.Hyperlink;
                    if (link != null)
                    {
        ...
        public void CreateSplitPane(int xSplitPos, int ySplitPos, int leftmostColumn, int topRow, PBetonSys.Utils.NPOI.SS.UserModel.PanePosition activePane)
        ...
        // public void CreateSplitPane(int xSplitPos, int ySplitPos, int topRow, int leftmostColumn, PBetonSys.Utils.NPOI.SS.UserModel.PanePosition activePane)
        {
        ...
        public PBetonSys.Utils.NPOI.SS.Util.PaneInformation PaneInformation
        {
            get
            {
        ...
        public double GetMargin(PBetonSys.Utils.NPOI.SS.UserModel.MarginType margin)
        {
        ...
        public void SetMargin(PBetonSys.Utils.NPOI.SS.UserModel.MarginType margin, double size)
        {
        ...
        public PBetonSys.Utils.NPOI.SS.UserModel.IDrawing CreateDrawingPatriarch()
        {
            if (_patriarch == null)
            {
        ...
        public void SetDefaultColumnStyle(int column, PBetonSys.Utils.NPOI.SS.UserModel.ICellStyle style)
        {
        ...
        public IComment GetCellComment(int row, int column)
        {
            ...
            if (r != null)
            {
                PBetonSys.Utils.NPOI.SS.UserModel.ICell c = r.GetCell(column);
                if (c != null)
                {
        ...
        /// </summary>
        public PBetonSys.Utils.NPOI.SS.UserModel.IWorkbook Workbook
        {
            get
            {
                return _workbook;
        ...
        public String SheetName
        {
            get
            {
                PBetonSys.Utils.NPOI.SS.UserModel.IWorkbook wb = Workbook;
