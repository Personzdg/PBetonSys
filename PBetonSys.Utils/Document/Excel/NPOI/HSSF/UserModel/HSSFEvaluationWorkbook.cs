...
namespace PBetonSys.Utils.NPOI.HSSF.UserModel
{
    ...
    public class HSSFEvaluationWorkbook : IFormulaRenderingWorkbook, IEvaluationWorkbook, IFormulaParsingWorkbook
    {
        ...
        private PBetonSys.Utils.NPOI.HSSF.Model.InternalWorkbook _iBook;

        public static HSSFEvaluationWorkbook Create(PBetonSys.Utils.NPOI.SS.UserModel.IWorkbook book)
        {
            if (book == null)
            {
                return null;
