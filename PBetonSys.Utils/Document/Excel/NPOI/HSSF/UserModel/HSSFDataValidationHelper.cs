...
namespace PBetonSys.Utils.NPOI.HSSF.UserModel
{
    ...
    public class HSSFDataValidationHelper : IDataValidationHelper
    {
         ...
         * 
         * @see
         * PBetonSys.Utils.NPOI.SS.UserModel.DataValidationHelper#CreateDateConstraint
         ...
         * 
         * @see
         * PBetonSys.Utils.NPOI.SS.UserModel.DataValidationHelper#CreateExplicitListConstraint
         * (java.lang.String[])
         */
         ...
         * 
         * @see
         * PBetonSys.Utils.NPOI.SS.UserModel.DataValidationHelper#CreateFormulaListConstraint
         * (java.lang.String)
         */
         ...
         * 
         * @see
         * PBetonSys.Utils.NPOI.SS.UserModel.DataValidationHelper#CreateNumericConstraint
         ...
         * 
         * @see
         * PBetonSys.Utils.NPOI.SS.UserModel.DataValidationHelper#CreateTextLengthConstraint
         * (int, java.lang.String, java.lang.String)
         */
         ...
         * 
         * @see
         * PBetonSys.Utils.NPOI.SS.UserModel.DataValidationHelper#CreateTimeConstraint
         * (int, java.lang.String, java.lang.String, java.lang.String)
         */
         ...
         * 
         * @see
         * PBetonSys.Utils.NPOI.SS.UserModel.DataValidationHelper#CreateValidation(org
         * .apache.poi.SS.UserModel.DataValidationConstraint,
         * PBetonSys.Utils.NPOI.SS.Util.CellRangeAddressList)
         */
