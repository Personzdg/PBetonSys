...
namespace PBetonSys.Utils.NPOI.HSSF.UserModel
{
    ...
    /// </summary>
    public class HSSFPrintSetup :PBetonSys.Utils.NPOI.SS.UserModel.IPrintSetup
    {
        ...
        public PBetonSys.Utils.NPOI.SS.UserModel.DisplayCellErrorType CellError
        {
            get { return (PBetonSys.Utils.NPOI.SS.UserModel.DisplayCellErrorType)printSetupRecord.CellError; }
