...
namespace PBetonSys.Utils.NPOI.HSSF.UserModel
{
    ...
    /// </summary>
    [Serializable]
    public class HSSFTextbox : HSSFSimpleShape //,PBetonSys.Utils.NPOI.SS.UserModel.ITextbox
    {
    ...
    public static short  VERTICAL_ALIGNMENT_DISTRIBUTED= 7;
        ...
        PBetonSys.Utils.NPOI.SS.UserModel.IRichTextString str = new HSSFRichTextString("");
        ...
        public virtual PBetonSys.Utils.NPOI.SS.UserModel.IRichTextString String
        {
            get { return str; }
            set
