...
namespace PBetonSys.Utils.NPOI.HSSF.UserModel
{
     ...
     * codes, etc.
     * 
     * Internally, formats will be implemented using subclasses of <see cref="PBetonSys.Utils.NPOI.SS.Util.FormatBase"/>
     * such as <see cref="PBetonSys.Utils.NPOI.SS.Util.DecimalFormat"/> and <see cref="PBetonSys.Utils.NPOI.SS.Util.SimpleDateFormat"/>. Therefore the
