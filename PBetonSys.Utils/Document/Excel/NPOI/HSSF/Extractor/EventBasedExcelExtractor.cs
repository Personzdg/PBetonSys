...
namespace PBetonSys.Utils.NPOI.HSSF.Extractor
{
    using System;
    using System.Text;
    using System.IO;
    ...
    using PBetonSys.Utils.NPOI;
    using PBetonSys.Utils.NPOI.HPSF;
    using PBetonSys.Utils.NPOI.SS.Formula.Eval;
    using PBetonSys.Utils.NPOI.HSSF.EventUserModel;
    ...
    public class EventBasedExcelExtractor : POIOLE2TextExtractor
    {
        ...
        private class TextListener : HSSFListener
        {
            ...
            private String FormatNumberDateCell(CellValueRecordInterface cell, double value)
            {
                ...
                {
                    // Is it a date?
                    if (PBetonSys.Utils.NPOI.SS.UserModel.DateUtil.IsADateFormat(formatIndex, formatString) &&
                            PBetonSys.Utils.NPOI.SS.UserModel.DateUtil.IsValidExcelDate(value))
                    {
                        ...
                        // Format as a date
                        DateTime d = PBetonSys.Utils.NPOI.SS.UserModel.DateUtil.GetJavaDate(value, false);
