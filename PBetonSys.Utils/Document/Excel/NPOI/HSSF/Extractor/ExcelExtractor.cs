...
namespace PBetonSys.Utils.NPOI.HSSF.Extractor
{
    ...
    public class ExcelExtractor : POIOLE2TextExtractor
    {
                    ...
                    for (int j = firstRow; j <= lastRow; j++)
                    {
                        ...
                        for (int k = firstCell; k < lastCell; k++)
                        {
                            ...
                            else
                            {
                                ...
                                PBetonSys.Utils.NPOI.SS.UserModel.IComment comment = cell.CellComment;
        ...
        /// <returns></returns>
        private String ExtractHeaderFooter(PBetonSys.Utils.NPOI.SS.UserModel.IHeaderFooter hf)
        {
            StringBuilder text = new StringBuilder();
