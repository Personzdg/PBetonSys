...
namespace PBetonSys.Utils.NPOI.HSSF.Util
{
    using System;
    using System.Collections;
    using PBetonSys.Utils.NPOI.HSSF.UserModel;
    ...
    public class HSSFCellUtil
    {
        ...
        public static PBetonSys.Utils.NPOI.SS.UserModel.IRow GetRow(int rowCounter, HSSFSheet sheet)
        {
            PBetonSys.Utils.NPOI.SS.UserModel.IRow row = sheet.GetRow(rowCounter);
            if (row == null)
            {
        ...
        public static PBetonSys.Utils.NPOI.SS.UserModel.ICell GetCell(PBetonSys.Utils.NPOI.SS.UserModel.IRow row, int column)
        {
            PBetonSys.Utils.NPOI.SS.UserModel.ICell cell = row.GetCell(column);
        ...
        public static PBetonSys.Utils.NPOI.SS.UserModel.ICell CreateCell(PBetonSys.Utils.NPOI.SS.UserModel.IRow row, int column, String value, HSSFCellStyle style)
        {
            PBetonSys.Utils.NPOI.SS.UserModel.ICell cell = GetCell(row, column);
        ...
        /// <param name="value">The value of the cell</param>
        /// <returns>A new HSSFCell.</returns>
        public static PBetonSys.Utils.NPOI.SS.UserModel.ICell CreateCell(PBetonSys.Utils.NPOI.SS.UserModel.IRow row, int column, String value)
        {
         ...
         */
        public static void SetCellStyleProperty(PBetonSys.Utils.NPOI.SS.UserModel.ICell cell, HSSFWorkbook workbook, String propertyName, Object propertyValue)
        {
            PBetonSys.Utils.NPOI.SS.UserModel.ICellStyle originalStyle = cell.CellStyle;
            PBetonSys.Utils.NPOI.SS.UserModel.ICellStyle newStyle = null;
            ...
            {
                PBetonSys.Utils.NPOI.SS.UserModel.ICellStyle wbStyle = workbook.GetCellStyleAt(i);
        ...
        private static Hashtable GetFormatProperties(PBetonSys.Utils.NPOI.SS.UserModel.ICellStyle style)
        {
        ...
        private static void SetFormatProperties(
                PBetonSys.Utils.NPOI.SS.UserModel.ICellStyle style, HSSFWorkbook workbook, Hashtable properties)
        {
            style.Alignment = (PBetonSys.Utils.NPOI.SS.UserModel.HorizontalAlignment)GetShort(properties, ALIGNMENT);
            style.BorderBottom = (PBetonSys.Utils.NPOI.SS.UserModel.BorderStyle)GetShort(properties, BORDER_BOTTOM);
            style.BorderLeft = (PBetonSys.Utils.NPOI.SS.UserModel.BorderStyle)GetShort(properties, BORDER_LEFT);
            style.BorderRight = (PBetonSys.Utils.NPOI.SS.UserModel.BorderStyle)GetShort(properties, BORDER_RIGHT);
            style.BorderTop = (PBetonSys.Utils.NPOI.SS.UserModel.BorderStyle)GetShort(properties, BORDER_TOP);
            ...
            style.FillPattern = (PBetonSys.Utils.NPOI.SS.UserModel.FillPatternType)GetShort(properties, FILL_PATTERN);
            ...
            style.VerticalAlignment = (PBetonSys.Utils.NPOI.SS.UserModel.VerticalAlignment)GetShort(properties, VERTICAL_ALIGNMENT);
