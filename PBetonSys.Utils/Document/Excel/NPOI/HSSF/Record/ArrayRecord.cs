...
namespace PBetonSys.Utils.NPOI.HSSF.Record
{
    ...
    public class ArrayRecord : SharedValueRecordBase
    {
        ...
        private PBetonSys.Utils.NPOI.SS.Formula.Formula _formula;
            ...
            : base(in1)
        {
		    ...
		    _formula = PBetonSys.Utils.NPOI.SS.Formula.Formula.Read(formulaTokenLen, in1, totalFormulaLen);
        }
        public ArrayRecord(PBetonSys.Utils.NPOI.SS.Formula.Formula formula, CellRangeAddress8Bit range):base(range)
        {
