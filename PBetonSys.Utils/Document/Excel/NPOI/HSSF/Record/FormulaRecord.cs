...
namespace PBetonSys.Utils.NPOI.HSSF.Record
{
    using System;
    using System.Text;
 ...
 */
    internal class SpecialCachedValue
    {
        ...
        public PBetonSys.Utils.NPOI.SS.UserModel.CellType GetValueType()
        {
            int typeCode = GetTypeCode();
            switch (typeCode)
            {
                case STRING: return PBetonSys.Utils.NPOI.SS.UserModel.CellType.STRING;
                case BOOLEAN: return PBetonSys.Utils.NPOI.SS.UserModel.CellType.BOOLEAN;
                case ERROR_CODE: return PBetonSys.Utils.NPOI.SS.UserModel.CellType.ERROR;
                case EMPTY: return PBetonSys.Utils.NPOI.SS.UserModel.CellType.STRING; // is this correct?
            }
    ...
    public class FormulaRecord : CellRecord
    {
        ...
        [NonSerialized]
        private PBetonSys.Utils.NPOI.SS.Formula.Formula field_8_parsed_expr;
...
*/
        ...
        {
            field_8_parsed_expr = PBetonSys.Utils.NPOI.SS.Formula.Formula.Create(Ptg.EMPTY_PTG_ARRAY);
        }
        ...
        public FormulaRecord(RecordInputStream in1):base(in1)
        {
                ...
                field_8_parsed_expr = PBetonSys.Utils.NPOI.SS.Formula.Formula.Read(field_7_expression_len, in1,in1.Available());
        }
        /**
 ...
 */
        ...
        {
            field_8_parsed_expr = PBetonSys.Utils.NPOI.SS.Formula.Formula.Create(ptgs);
        }
        ...
        public Ptg[] ParsedExpression
        {
            ...
            set { field_8_parsed_expr = PBetonSys.Utils.NPOI.SS.Formula.Formula.Create(value); }
        }
        public PBetonSys.Utils.NPOI.SS.Formula.Formula Formula
        {
            get
            {
        ...
        public PBetonSys.Utils.NPOI.SS.UserModel.CellType CachedResultType
        {
            get
            {
                if (specialCachedValue == null)
                {
                    return PBetonSys.Utils.NPOI.SS.UserModel.CellType.NUMERIC;
                }
                return (PBetonSys.Utils.NPOI.SS.UserModel.CellType)specialCachedValue.GetValueType();
            }
        }
