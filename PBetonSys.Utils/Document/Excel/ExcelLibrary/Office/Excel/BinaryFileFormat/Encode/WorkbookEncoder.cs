...
using System.Text;
using System.IO;
using PBetonSys.Utils.ExcelLibrary.CompoundDocumentFormat;
using QiHe.CodeLib;
using PBetonSys.Utils.ExcelLibrary.BinaryDrawingFormat;
using PBetonSys.Utils.ExcelLibrary.SpreadSheet;

namespace PBetonSys.Utils.ExcelLibrary.BinaryFileFormat
{
