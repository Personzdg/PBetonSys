...
namespace PBetonSys.Utils.EPPlus.Style
{
    ...
    {
        internal ExcelNumberFormat(ExcelStyles styles, PBetonSys.Utils.EPPlus.XmlHelper.ChangedEventHandler ChangedEvent, int PositionID, string Address, int index) :
