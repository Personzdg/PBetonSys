...
namespace PBetonSys.Utils.EPPlus.Style
{
    ...
    {
        internal ExcelGradientFill(ExcelStyles styles, PBetonSys.Utils.EPPlus.XmlHelper.ChangedEventHandler ChangedEvent, int PositionID, string address, int index) :
