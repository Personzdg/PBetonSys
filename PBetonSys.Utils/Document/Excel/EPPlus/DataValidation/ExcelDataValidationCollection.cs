...
using PBetonSys.Utils.EPPlus.Utils;
using System.Xml;
using PBetonSys.Utils.EPPlus.DataValidation.Contracts;

namespace PBetonSys.Utils.EPPlus.DataValidation
{
    /// <summary>
    /// <para>
    ...
    public class ExcelDataValidationCollection : XmlHelper, IEnumerable<IExcelDataValidation>
    {
        ...
        public bool Remove(IExcelDataValidation item)
        {
            ...
            {
                throw new InvalidCastException("The supplied item must inherit PBetonSys.Utils.EPPlus.DataValidation.ExcelDataValidation");
            }
