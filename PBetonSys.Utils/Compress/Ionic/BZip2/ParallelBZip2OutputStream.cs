...
namespace PBetonSys.Utils.Ionic.BZip2
{
    ...
    ///
    /// <para>
    ///   This class is similar to <see cref="PBetonSys.Utils.Ionic.BZip2.BZip2OutputStream"/>,
    ...
    /// </para>
    ///
    /// <seealso cref="PBetonSys.Utils.Ionic.BZip2.BZip2OutputStream" />
    public class ParallelBZip2OutputStream : System.IO.Stream
    {
        ...
        ///       {
        ///           using (var compressor = new PBetonSys.Utils.Ionic.BZip2.ParallelBZip2OutputStream(output))
        ///           {
