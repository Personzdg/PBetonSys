...
namespace PBetonSys.Utils.Ionic.Zip
{
    ...
    public partial class ZipFile
    {
        ...
        ///
        /// <exception cref="PBetonSys.Utils.Ionic.Zip.BadStateException">
        ...
        ///
        /// <code lang="C#">
        /// using (var zip = new PBetonSys.Utils.Ionic.Zip.ZipFile())
        /// {
        ///     zip.CompressionLevel= PBetonSys.Utils.Ionic.Zlib.CompressionLevel.BestCompression;
        ...
        /// {
        ///   using (var zip = PBetonSys.Utils.Ionic.Zip.ZipFile.Read(inputStream))
        ///   {
        ...
        ///
        /// <code lang="C#">
        /// using (var zip = PBetonSys.Utils.Ionic.Zip.ZipFile.Read(filename))
        /// {
        ///     zip.AddEntry("Name1.txt", "this is the content");
        ///     zip.Save();  // YES!
        /// }
