...
namespace PBetonSys.Utils.Ionic.Zip
{
    ...
    partial class ZipFile
    {
                                               ...
                                               bool wantUpdate)
        {
            ...
            PBetonSys.Utils.Ionic.FileSelector ff = new PBetonSys.Utils.Ionic.FileSelector(selectionCriteria,
...
namespace PBetonSys.Utils.Ionic
{
    internal abstract partial class SelectionCriterion
    {
        internal abstract bool Evaluate(PBetonSys.Utils.Ionic.Zip.ZipEntry entry);
    }


    internal partial class NameCriterion : SelectionCriterion
    {
        internal override bool Evaluate(PBetonSys.Utils.Ionic.Zip.ZipEntry entry)
        {
    ...
    {
        private bool Evaluate(PBetonSys.Utils.Ionic.Zip.ZipEntry entry)
        {
        ...
        public ICollection<PBetonSys.Utils.Ionic.Zip.ZipEntry> SelectEntries(PBetonSys.Utils.Ionic.Zip.ZipFile zip)
        {
            if (zip == null)
                throw new ArgumentNullException("zip");

            var list = new List<PBetonSys.Utils.Ionic.Zip.ZipEntry>();

            foreach (PBetonSys.Utils.Ionic.Zip.ZipEntry e in zip)
            {
                if (this.Evaluate(e))
                    list.Add(e);
            }
        ...
        ///
        /// <returns>a collection of ZipEntry objects that conform to the criteria.</returns>
        public ICollection<PBetonSys.Utils.Ionic.Zip.ZipEntry> SelectEntries(PBetonSys.Utils.Ionic.Zip.ZipFile zip, string directoryPathInArchive)
        {
            if (zip == null)
                throw new ArgumentNullException("zip");
