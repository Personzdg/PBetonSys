...
namespace PBetonSys.Utils.Ionic.Zip
{
    ...
    public class SelfExtractorSaveOptions
    {
        ...
        /// </para>
        /// </remarks>
        public PBetonSys.Utils.Ionic.Zip.ExtractExistingFileAction ExtractExistingFile
        {
            get;
            set;
        }
    ...
    partial class ZipFile
    {
        ...
        private static ExtractorSettings[] SettingsList = {
            new ExtractorSettings() {
                ...
                CopyThroughResources = new List<string>{
                    "PBetonSys.Utils.Ionic.Zip.WinFormsSelfExtractorStub.resources",
                    "PBetonSys.Utils.Ionic.Zip.Forms.PasswordDialog.resources",
                    "PBetonSys.Utils.Ionic.Zip.Forms.ZipContentsDialog.resources"},
        ...
        //         "namespace PBetonSys.Utils.Ionic.Zip { public partial class WinFormsSelfExtractorStub { partial void _SetDefaultExtractLocation() {" +
        ...
        private void _SaveSfxStub(string exeToGenerate, SelfExtractorSaveOptions options)
        {
            ...
            try
            {
                ...
                // get the PBetonSys.Utils.Ionic.Zip assembly
                ...
                using (var csharp = new Microsoft.CSharp.CSharpCodeProvider())
                {
                    ...
                    // This is the list of referenced assemblies.  PBetonSys.Utils.Ionic.Zip is
                    ...
                    using (ZipFile zip = ZipFile.Read(a2.GetManifestResourceStream("PBetonSys.Utils.Ionic.Zip.Resources.ZippedResources.zip")))
                    {
                        ...
                        {
                            // Use the ico file that is embedded into the PBetonSys.Utils.Ionic.Zip
                        ...
                        // add the PBetonSys.Utils.Ionic.Utils.Zip DLL as an embedded resource
