...
namespace PBetonSys.Utils.Ionic.Zip
{
    ...
    ///   cref="PBetonSys.Utils.Ionic.Zip.ZipFile.AddEntry(string, WriteDelegate)"/>, the application
    ...
    /// </code>
    /// </example>
    /// <seealso cref="PBetonSys.Utils.Ionic.Zip.ZipFile.AddEntry(string, WriteDelegate)"/>
    ...
    ///
    /// <remarks>
    ///   When you add an entry via <see cref="PBetonSys.Utils.Ionic.Zip.ZipFile.AddEntry(string,
    ...
    /// </remarks>
    ///
    /// <seealso cref="PBetonSys.Utils.Ionic.Zip.ZipFile.AddEntry(string, OpenDelegate, CloseDelegate)"/>
    ...
    /// </para>
    /// </remarks>
    /// <seealso cref="PBetonSys.Utils.Ionic.Zip.ZipFile.SetCompression"/>
    public delegate PBetonSys.Utils.Ionic.Zlib.CompressionLevel SetCompressionCallback(string localFileName, string fileNameInArchive);
