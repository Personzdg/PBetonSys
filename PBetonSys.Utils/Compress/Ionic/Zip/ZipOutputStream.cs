...
// generating zip files.  This class does not depend on PBetonSys.Utils.Ionic.Zip.ZipFile, but rather
...
namespace PBetonSys.Utils.Ionic.Zip
{
    ...
    public class ZipOutputStream : Stream
    {
        ...
        private void _Init(Stream stream, bool leaveOpen, string name)
        {
            ...
            Strategy = PBetonSys.Utils.Ionic.Zlib.CompressionStrategy.Default;
            _name = name ?? "(stream)";
#if !NETCF
        ...
        ///   cref="PBetonSys.Utils.Ionic.Zlib.CompressionStrategy "/>.
        /// </remarks>
        ...
        public bool UseUnicodeAsNecessary
        {
            ...
            set
            {
                ...
                {
                    _alternateEncoding = PBetonSys.Utils.Ionic.Zip.ZipOutputStream.DefaultEncoding;
        ...
        ///     cref="PBetonSys.Utils.Ionic.Zlib.CompressionLevel.BestSpeed"/>.  You may have to perform
        ...
        private PBetonSys.Utils.Ionic.Crc.CrcCalculatorStream _entryOutputStream;
...
#if !NETCF
        public PBetonSys.Utils.Ionic.Zlib.ParallelDeflateOutputStream ParallelDeflater
        {
            get
            {
