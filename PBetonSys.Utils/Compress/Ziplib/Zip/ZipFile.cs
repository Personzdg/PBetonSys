...
using PBetonSys.Utils.ZipLib.Encryption;
#endif

using PBetonSys.Utils.ZipLib.Core;
using PBetonSys.Utils.ZipLib.Checksums;
using PBetonSys.Utils.ZipLib.Zip.Compression.Streams;
using PBetonSys.Utils.ZipLib.Zip.Compression;

namespace PBetonSys.Utils.ZipLib.Zip 
{
	...
	/// using System.IO;
	/// 
	/// using PBetonSys.Utils.ZipLib.Zip;
	/// 
	/// class MainClass
	/// {
	...
	public class ZipFile : IEnumerable, IDisposable
	{
		...
		/// </exception>
		/// <exception cref="PBetonSys.Utils.ZipLib.Zip.ZipException">
